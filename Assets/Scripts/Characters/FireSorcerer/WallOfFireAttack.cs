...
public class WallOfFireAttack : MonoBehaviour, IAbility
{
    [Header("Required References")]
    public CharacterData characterData;
    public AbilityData abilityData;
    public GameObject wallOfFirePrefab;
    public SpriteRenderer playerSprite;
    public Transform castPoint;
    public Animator animator;

    [Header("Wall Settings")]
    public float wallDuration = 0.05f;
    ...
    void CreateWall()
    {
        ...
        GameObject wall = Instantiate(wallOfFirePrefab, spawnPosition, Quaternion.identity);
        ...
        WallOfFireController wallController = wall.GetComponent<WallOfFireController>();
        if (wallController == null) wallController = wall.AddComponent<WallOfFireController>();
